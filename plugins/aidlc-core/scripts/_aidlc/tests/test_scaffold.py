...
class TestScaffoldSansEtapePrevue(AidlcTestCase):
    ...
    def test_valeurs_par_defaut_sans_input_ni_role_ni_equipe(self):
        ...
        self.assertEqual(manifest["human_role"], "rôle métier à préciser")
        self.assertEqual(manifest["team"], "<équipe propriétaire de cet agent>")
        ...
        self.assertIn("- Aucune entrée amont.", skill)
