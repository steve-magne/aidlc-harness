...
* [ADR-0009 — L'initiative est une unité de travail, le workflow se compose, le feedback remonte](sources/adr-0009-initiative-workflow-et-feedback.md) - Un projet mène plusieurs idées dans le temps sans que la seconde écrase la première ; composer la chaîne devient une commande outillée plutôt qu'une édition JSON ; le contrat absent ferme la porte et l'approbation motivée alimente la boucle d'amélioration.
